...
from deep_learning.image_enhancement import ImageEnhancement
from deep_learning.image_generation import ImageGenerator
...
if __name__ == "__main__":
    ...
    image_enhancement = ImageEnhancement(file_handler)
    image_generator = ImageGenerator(file_handler)
    ...
    deep_learning_ui = DeepLearningUI(main_ui.sidebar, ai_image_segmentation, image_enhancement, image_generator, style_transfer)
